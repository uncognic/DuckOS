...
cls
echo %c_green%[FINISHED] %c_gold%Step 1/5 finished. Cleaning up the image...
Dism /Image:%BuildInProgressPath% /cleanup-image /StartComponentCleanup /ResetBase 
echo %c_green%[  INFO  ] %c_cyan%Done.

:: Save changes
echo %c_green%[FINISHED] %c_gold%Step 2/5 finished. Saving changes...
Dism /Unmount-Image /MountDir:%BuildInProgressPath% /Commit
echo %c_green%[  INFO  ] %c_cyan%Done.

:: Export the image as a new .wim
echo %c_green%[FINISHED] %c_gold%Step 3/5 finished. Exporting image...
...
echo %c_green%[FINISHED] %c_gold%Step 4/5 finished. Changing the file name...
...
echo %c_green%[FINISHED] %c_gold%Step 5/5 finished. Converting install.wim to install.esd to save space...
